...
namespace KSPPluginFramework
{
    ...
    internal sealed class WindowInitialsAttribute : Attribute
    {
        ...
        public bool WindowMoveEventsEnabled { get; set; }
    }

    /// <summary>
    ///     An Extended version of the UnityEngine.MonoBehaviour Class
    ///     Basically a template for a Window, has the MonoBehaviourExtended properties and extra bits to make drawing a window
    ///     easier
    /// </summary>
    public abstract class MonoBehaviourWindow : MonoBehaviourExtended
    {
        ...
        public delegate void WindowVisibleHandler(MonoBehaviourWindow sender, bool NewVisibleState);
        ...
        private bool _WindowMoveEventsEnabled;

        /// <summary>
        ///     Whether the window can be moved off the visible screen
        /// </summary>
        internal bool ClampToScreen = true;

        /// <summary>
        ///     How close to the edges it can get if clamping is enabled - this can be negative if you want to allow it to go off
        ///     screen by a certain amount
        /// </summary>
        ...
        /// <summary>
        ///     A defined area (like a handle) where you can drag from. This is from the top left corner of the window. Lets you
        ///     make isso it can be only draggable from a certain point, icon, title bar, etc
        /// </summary>
        ...
        /// </summary>
        private bool WindowMoveStarted;
        ...
        /// <summary>
        ///     Window position on screen, is fed in to the Window routine and the resulting position after GUILayout is what you
        ///     read
        /// </summary>
        ...
        public bool WindowMoveEventsEnabled
        {
            get => _WindowMoveEventsEnabled;
            set
            {
                _WindowMoveEventsEnabled = value;
        ...
        {
            get => _WindowMoveCompleteAfter;
            set => _WindowMoveCompleteAfter = value;
        }

        /// <summary>
        ///     Whether the Window is visible or not. Changing this value will add/remove the window from the
        ///     RenderingManager.PostDrawQueue
        /// </summary>
        ...
        /// <summary>
        ///     Time that the last iteration of RepeatingWorkerFunction ran for. Can use this value to see how much impact your
        ///     code is having
        /// </summary>
        ...
        internal override void OnGUIEvery()
        {
            ...
            if (Visible && blnFlightUIVisible &&
                !(HighLogic.LoadedScene == GameScenes.FLIGHT && PauseMenu.isOpen)) DrawGUI();
        }
        ...
        private void DrawGUI()
        {
            ...
            if (WindowStyle == null)
                ...
                WindowRect = GUILayout.Window(WindowID, WindowRect, DrawWindowInternal, WindowCaption, WindowStyle,
                    WindowOptions);
        ...
        /// <summary>
        ///     Private function that handles wrapping the drawwindow functionality with the supplementary stuff - dragging,
        ///     tooltips, etc
        /// </summary>
        ...
        private void DrawWindowInternal(int id)
        {
            ...
            IsMouseOver = WindowRect.Contains(Event.current.mousePosition);
        ...
        /// </summary>
        /// <param name="id">The ID of the Window being drawn</param>
        internal virtual void DrawWindowPre(int id)
        {
        }
        ...
        internal MonoBehaviourWindow()
        {
            ...
            var attrs = (WindowInitialsAttribute[]) Attribute.GetCustomAttributes(GetType(),
                typeof(WindowInitialsAttribute));
        ...
        internal bool blnFlightUIVisible = true;
        ...
        /// </summary>
        internal bool TooltipShown { get; private set; }

        /// <summary>
        ///     Whereis the tooltip positioned
        /// </summary>
        internal Rect TooltipPosition => _TooltipPosition;

        private Rect _TooltipPosition = new Rect();

        /// <summary>
        ///     An offset from the mouse position to put the top left of the tooltip. Use this to get the tooltip out from under
        ///     the cursor
        /// </summary>
        ...
        private void DrawToolTip()
        {
            ...
            if (TooltipsEnabled && Visible && strToolTipText != "" &&
                (TooltipDisplayForSecs == 0 || fltTooltipTime < TooltipDisplayForSecs))
            {
                ...
                if (TooltipMaxWidth > 0)
                {
                    ...
                    SkinsLibrary.CurrentTooltip.CalcMinMaxWidth(contTooltip, out minwidth,
                        out maxwidth); // figure out how wide one line would be
                    _TooltipPosition.width = Math.Min(TooltipMaxWidth - SkinsLibrary.CurrentTooltip.padding.horizontal,
                        maxwidth); //then work out the height with a max width
                    _TooltipPosition.height =
                        SkinsLibrary.CurrentTooltip.CalcHeight(contTooltip, TooltipPosition.width); // heres the result
                }
                else
                {
                    //calc the new width and height
        ...
        {
            if (Event.current.type == EventType.Repaint) strToolTipText = GUI.tooltip;
        }
