...
namespace KSPPluginFramework
{
    ...
    ///     Using the simple contructor new MonobehaviourExtended() will NOT register the object to receive Unity events and
    ///     you will wonder why no events are firing
    /// </remarks>
    ...
    public abstract class MonoBehaviourExtended : MonoBehaviour
    {
        ...
        /// </summary>
        internal bool RepeatingWorkerRunning { get; private set; }
        ...
        /// </summary>
        internal float RepeatingWorkerRate
        {
            get => _RepeatSecs;
            private set
            {
        ...
        internal float SetRepeatTimesPerSecond(int NewTimesPerSecond)
        {
            RepeatingWorkerRate = 1 / (float) NewTimesPerSecond;
        ...
        /// <param name="NewTimesPerSecond">Number of times per second to repeat</param>
        /// <returns>The new RepeatSecs value (eg 0.25 from the example)</returns>
        internal float SetRepeatTimesPerSecond(float NewTimesPerSecond)
        {
            RepeatingWorkerRate = 1 / NewTimesPerSecond;
            return RepeatingWorkerRate;
        }
        ...
        internal float SetRepeatRate(float NewSeconds)
        {
        ...
        ///     eg. If you set this to 1 and then start the repeating function then the first time it fires will be in 1 second and
        ///     then every RepeatSecs after that
        /// </summary>
        internal float RepeatingWorkerInitialWait { get; set; }
        ...
        internal bool StartRepeatingWorker(int TimesPerSec)
        {
        ...
        /// </summary>
        /// <returns>The RunningState of the RepeatinWorker Function</returns>
        internal bool StartRepeatingWorker()
        {
            try
            {
                LogFormatted_DebugOnly("Invoking the repeating function");
                this.InvokeRepeating("RepeatingWorkerWrapper", RepeatingWorkerInitialWait, RepeatingWorkerRate);
                RepeatingWorkerRunning = true;
            }
            catch (Exception)
            {
        ...
        ///     NOTE: Inside the RepeatingWorker Function this will be the UT that has passed since the last run of the
        ///     RepeatingWorker
        /// </summary>
        ...
        private static bool randomInitialized;
        ...
        /// <summary>
        ///     Unity: Start is called on the frame when a script is enabled just before any of the Update methods is called the
        ///     first time.
        ...
        ///     Trigger: This Update is called at a fixed rate and usually where you do all your physics stuff for consistent
        ///     results
        ///     See this for info on order of execuction: http://docs.unity3d.com/Documentation/Manual/ExecutionOrder.html
        /// </summary>
        ...
        ///     Trigger: This Update is called just before the rendering, and where you can adjust any graphical values/positions
        ///     based on what has been updated in the physics, etc
        ///     See this for info on order of execuction: http://docs.unity3d.com/Documentation/Manual/ExecutionOrder.html
        /// </summary>
        ...
        /// <summary>
        ///     <summary>
        ///         Unity: OnPreCull is called before a camera culls the scene. This function is called only if the script is
        ///         attached to the camera and is enabled.
        ///         Trigger: This function is one of the first in the Scene Rendering part of the update loop. When the plugin sees
        ///         thi function all the background logic is completed
        ///         At this point in the loop all the positions for onscreen elements are set and using this section can lead to
        ///         nolag updates on graphic objects
        ///         NOTE: The class must be attached to a camera object to have this get called -  obj =
        ///         MapView.MapCamera.gameObject.AddComponent
        ///         <MBExtended>
        ///             ();
        ///             See this for info on order of execuction: http://docs.unity3d.com/Documentation/Manual/ExecutionOrder.html
        ///     </summary>
        ...
        private bool _OnGUIOnceOnlyHasRun;
        ...
        ///     Code here ignores the F2 key that disables user interface. So if you are making something to be user hidable then
        ///     use the RenderingManager.PostDrawQueue functions in here
        ...
        /// <summary>
        ///     Extension Function - OnGUIEvery is wrapped in OnGUI with some stuff to facilitate the OnGUIOnceOnly functionality,
        ///     basically this is the OnGUI function
        ///     Unity: OnGUI is called for rendering and handling GUI events.
        ///     Trigger: This is called multiple times per frame to lay stuff out etc.
        ///     Code here ignores the F2 key that disables user interface. So if you are making something to be user hidable then
        ///     use the RenderingManager.PostDrawQueue functions in here
        ...
        ///     Added this so you can put your GUI initialisation code in here. Running GUI initialisation stuff in Awake/Start
        ///     will throw an error
        /// </summary>
