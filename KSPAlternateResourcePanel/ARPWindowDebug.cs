...
namespace KSPAlternateResourcePanel
{
    ...
    {
        public static int intTest5 = 10;

        public int intTest1 = 339;
        public int intTest2;
        public int intTest3 = 299;
        public int intTest4 = 20;
        ...
        internal override void DrawWindow(int id)
        {
            ...
            mbARP.windowMainResetPos = new Rect(Screen.width - intTest1 - GameSettings.UI_SCALE_APPS * 42, intTest2,
                intTest3, intTest4);
            ...
            GUILayout.Label(string.Format("Repeating Worker: {0:0.00}ms  Config:{1}-{2}-{3}",
                mbARP.RepeatingWorkerDuration.TotalMilliseconds, mbARP.RepeatingWorkerRunning,
                mbARP.RepeatingWorkerInitialWait, mbARP.RepeatingWorkerRate));
            GUILayout.Label(string.Format("UT Passed: {0}s", mbARP.RepeatingWorkerUTPeriod.ToString()));
            GUILayout.Label(string.Format("RT Passed: {0}s",
                (mbARP.RepeatingWorkerUTPeriod * TimeWarp.CurrentRate).ToString()));

            GUILayout.Label(string.Format("Draw Settings Duration: {0:0.00}ms",
                mbARP.windowSettings.DrawWindowInternalDuration.TotalMilliseconds));
            GUILayout.Label(string.Format("Draw Main Duration: {0:0.00}ms",
                mbARP.windowMain.DrawWindowInternalDuration.TotalMilliseconds));
            ...
            foreach (var item in mbARP.lstTransfers)
